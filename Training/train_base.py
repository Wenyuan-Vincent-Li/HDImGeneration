        ...
        for j, data in enumerate(dataloader):
            ...
            if (j==0) & (epoch == 0): # first iteration training in this level
                if Gs == []:
                    ...
                    prev = draw_concat(Gs, Zs, data['label'], maskTransform, reals, NoiseAmp, in_s, 'rand', m_noise, m_image, opt)
                    ...
                    z_prev = draw_concat(Gs, Zs, data['label'], maskTransform, reals, NoiseAmp, in_s, 'rec', m_noise, m_image, opt) ## [1, 3, 33, 33]
