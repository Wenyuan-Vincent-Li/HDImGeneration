        ...
        for j, data in enumerate(dataloader):
            ...
            if (j==0) & (epoch == 0): # first iteration training in this level
                if Gs == []:
                    ...
                    z_prev = draw_concat(Gs, Zs, data['label'], reals, NoiseAmp, in_s, 'rec', m_noise, m_image, opt) ## [1, 3, 33, 33]
...
def draw_concat(Gs,Zs,mask,reals,NoiseAmp,in_s,mode,m_noise,m_image,opt):
    '''
    :param Gs: [G0]
