...
def train_single_scale(dataloader, netD, netG, reals, Gs, in_s, NoiseAmp, opt):
    '''
    :param netD: currD
    :param netG: currG
    ...
    functions.save_networks(netG, netD, opt)  ## save netG, netD, z_opt, opt is used to parser output path
    return in_s, netG
